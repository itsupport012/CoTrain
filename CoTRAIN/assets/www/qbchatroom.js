...
function connectChat(chatUser) {
	...
	connection.connect(userJID, userPass, function (status) {
		...
		case Strophe.Status.CONNECTED:
			...
			//connection.muc.join("8335_group1@muc.chat.quickblox.com", chatUser.qbID, getMessage, getPresence, getRoster);
			//connection.muc.join("8335_group2@muc.chat.quickblox.com", chatUser.qbID, getMessage, getPresence, getRoster);
			//connection.muc.join("8335_group3@muc.chat.quickblox.com", chatUser.qbID, getMessage, getPresence, getRoster);
...
function SendMessageCotrain( groupID){
		message = {
