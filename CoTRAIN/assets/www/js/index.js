...
var app = {
    ...
    onDeviceReady: function() {
        ...
        pushNotification.register(app.successHandler, app.errorHandler,{"senderID":"600189233901","ecb":"app.onNotificationGCM"});
            ...
            case 'registered':
                if ( e.regid.length > 0 )
                {
                   // console.log("Regid " + e.regid);
					...
					window.localStorage.setItem("android_reg_id",e.regid);
                }
                break;
